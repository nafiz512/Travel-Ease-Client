                        ...
                        <div className="mt-2">
                            ...
                            <div className="flex">
                                <input
                                    ...
                                    className="flex-1 px-3  text-sm border border-base-300 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
                                />
                                <button className="bg-primary text-white px-4 py-2 rounded-r-lg hover:bg-primary-focus transition-colors text-sm font-medium">
                                    Subscribe
                                </button>
                            </div>
                        </div>
